...
<body>
	...
	<a href="/projectlist"><input type="button" value="update project" ></a> --%>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Completed Task</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><%=request.getAttribute("cmpltCnt") %></div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Pending Task</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><%=request.getAttribute("pendCnt") %></div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Ready to review Task</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><%=request.getAttribute("revCnt") %></div>
                                            </div>
                                            <div class="col-auto">
                                                    <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                             </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Project Worked on</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><%=request.getAttribute("prjctCnt") %></div>
                                        </div>
                                        <div class="col-auto">
    ...
    <!-- Page level plugins -->
    <script src="./dashboard-style/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="./dashboard-style/js/demo/chart-area-demo.js"></script>
    <script src="./dashboard-style/js/demo/chart-pie-demo.js"></script>
